...
def test_create_shift(test_app):
...
def test_get_x_reports_valid_shift(test_app):
...
def test_get_x_reports_non_existent_shift(test_app):
...
def test_close_already_closed_shift(test_app):
...
def test_close_non_existent_shift(test_app):
...
def test_get_sales_report(test_app):
